...
class Segmentation_Network(nn.Module):
    ...
    def forward(self, x):
        ...
        x_0_0 = self.stageSAR_0(x[:, :3, :, :])
        x_1_0 = self.stageSAR_1(self.pool(x_0_0))
        x_2_0 = self.stageSAR_2(self.pool(x_1_0))
        x_3_0 = self.stageSAR_3(self.pool(x_2_0))
        x_4_0 = self.stageSAR_4(self.pool(x_3_0))
