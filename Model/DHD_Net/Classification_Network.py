...
class Classification_Network(nn.Module):
    ...
    def forward(self, x):
        x_0_0 = self.stageMS_0(x)
        x_1_0 = self.stageMS_1(self.pool(x_0_0))
        x_2_0 = self.stageMS_2(self.pool(x_1_0))
        x_3_0 = self.stageMS_3(self.pool(x_2_0))
        x_4_0 = self.stageMS_4(self.pool(x_3_0))
